...
async def send_telegram_message(bot_token: str, chat_id: int, text: str, *, parse_mode: Literal["MarkdownV2"] = "MarkdownV2", need_log: bool = False):
    ...
    for i, chunk in enumerate(chunks):
        ...
        if i == len(chunks) -  1:  # Check if it's the last message
            inline_keyboard = {
                "inline_keyboard": [
                    [
                        {
